...
int main(int argc, char** argv)
{
    try
    {
        ...
        if (argc != 2)
        {
            ...
            cout << "   ./glass_train_shape_predictor_ex faces" << endl;
            cout << endl;
            return 0;
        }
        ...
        load_image_dataset(images_train, faces_train, faces_directory+"/training_with_glass_landmarks.xml");
