...
{  
    ...
    try
    {
        // In this example we are going to train a glass detector based on the
        // small glass dataset in the examples/glass_training_46ps directory.  So the first
        ...
        if (argc != 2)
        {
            ...
            cout << "   ./glass_fhog_object_detector_ex glass_training_46ps" << endl;
            cout << endl;
            return 0;
        }
        ...
        scanner.set_detection_window_size(144,44);
        ...
        // serialize() function.
        serialize("glass_detector.svm") << detector;
